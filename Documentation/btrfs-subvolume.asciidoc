...
*snapshot* [-r] <source> [<dest subdir>/]<name> | <dest subdir>::

Create a new subvolume and initialize it with a snapshot of <source>.

if only <source> <dest> is given, the new subvolume (the snapshot) will be named the basename of <source>.
+
